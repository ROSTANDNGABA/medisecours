...
const STATUT_BADGE = {
  OUVERTE:  'bg-primary-100 text-primary-700',
  EN_COURS: 'bg-mint-100 text-mint-700',
  TERMINEE: 'bg-gray-100 text-gray-600',
  ANNULEE:  'bg-urgence-100 text-urgence-700',
}
const STATUT_LABEL = {
  OUVERTE: 'Ouverte', EN_COURS: 'En cours', TERMINEE: 'Terminée', ANNULEE: 'Annulée',
}
const TABS = [
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {c.statut === 'EN_COURS' && (
                    <button
                      ...
                      className="px-3.5 py-2 rounded-xl text-xs font-semibold bg-mint-500 hover:bg-mint-700 text-white"
                    >
                      Terminer
                    </button>
                  )}
